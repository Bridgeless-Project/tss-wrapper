...
func (x *GetTasksResponse) GetRecords() []*TaskRecord {
	if x != nil {
		return x.Records
	}
	return nil
...
type UpdateDataRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Certificates  []*Certiticate         `protobuf:"bytes,1,rep,name=certificates,proto3" json:"certificates,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateDataRequest) GetCertificates() []*Certiticate {
	if x != nil {
...
func (x *UpdateDataResponse) GetStatus() ProcessStatus {
	if x != nil {
		return x.Status
	}
	return ProcessStatus_PROCESS_STATUS_CREATED
...
var file_api_proto_goTypes = []any{
	...
	(ProcessStatus)(0),          // 6: ProcessStatus
	(*TaskRecord)(nil),          // 7: TaskRecord
	(*Certiticate)(nil),         // 8: Certiticate
}
